...
import * as windows1258 from '../windows-1258.mjs';

console.log('Testing `windows1258.encode`…');
assert.strictEqual(
...
console.log('Testing `windows1258.decode`…');
assert.strictEqual(
...
console.log('Testing `windows1258.labels`…');
assert.ok(Array.isArray(windows1258.labels));
assert.ok(windows1258.labels.length > 0);
